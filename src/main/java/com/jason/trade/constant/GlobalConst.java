...
public class GlobalConst {
    ...
    //size
    public static final String[] HEAD_CONTRACT_ARRAY = new String[]{"序号","外合同编号","内合同编号","合同日期","外商","原产地","储存条件","价格条件","目的港","币种","付款方式","预计船期","汇率","箱数总计","合同总重量(KG)","合同总金额(元)","发票总重量(KG)","发票总金额(元)","预售客户名称","预售时间","预售单价(元/KG)","预售重量(kg)","开证行","开证日期","LC NO.","付汇日","付汇汇率","已办理押汇","押汇金额","押汇年利率","押汇到期日","到期日汇率","预付款金额","预付款日期","预付款银行","尾款银行","预付款汇率","尾款金额","尾款日期","尾款汇率","已办理融资","融资银行","融资金额","融资年利率","融资到期日","到期日汇率","柜号","提单号","货柜尺寸","需要购买保险","保险公司","保险购买日期","保费","ETD","ETA","已核对电子版","已出检疫证","已出报关单","货代","单据寄给货代日期","关税","增值税","付税日期","报关单号","放行日期","仓库","入库日期","采样仓库","采样日期","滞箱费","滞港费","备注","商品属性"};
    //size
    ...
    public static final String[] HEAD_CONTRACT_QUERY_ARRAY = new String[]{"外合同编号","内合同编号","外商","合同日期","合同总重量","合同总金额","发票总重量","发票总金额","总箱数","原产地","币种","ETD","ETA","预计船期","目的港","状态"};
    public static final String[] HEAD_CARGO_QUERY_ARRAY = new String[]{"外合同编号","内合同编号","外商","原产地","合同日期","厂号","柜号","币种","商品","级别","库存箱数","单价","合同重量","合同金额","发票重量","发票金额","ETD","ETA","预计船期","目的港","状态"};
