...
public class GlobalConst {
    ...
    public static final String[] HEAD_CONTRACT_QUERY_ARRAY = new String[]{"外合同编号","内合同编号","外商","合同日期","合同总重量","合同总金额","发票总重量","发票总金额","原产地","币种","ETA","ETD","预计船期","状态"};
    public static final String[] HEAD_CARGO_QUERY_ARRAY = new String[]{"外合同编号","内合同编号","外商","原产地","合同日期","厂号","柜号","币种","商品","级别","单价","合同重量","合同金额","发票重量","发票金额","ETD","ETA","预计船期","状态"};
