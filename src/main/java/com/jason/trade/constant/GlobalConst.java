...
public class GlobalConst {
    ...
    //size
    public static final String[] HEAD_CONTRACT_ARRAY = new String[]{"序号","外合同编号","内合同编号","合同日期","外商","原产地",
            ...
            "尾款金额","尾款日期","尾款汇率","已办理融资","融资银行","融资金额","融资年利率","融资到期日","到期日汇率","柜号","提单号",
            "货柜尺寸","需要购买保险","保险公司","保险购买日期","保费","ETD","ETA","货代费","电子单据收到日期","检疫证正本收到日期","检疫证签发日期","报关单出具日期",
            "货代","正本单据收到日期","关税","增值税","付税日期","报关单号","放行日期","仓库","入库日期","采样仓库","采样日期","滞箱费",
            "滞港费","备注","商品属性"};
    //size
    public static final String[] HEAD_CARGO_ARRAY = new String[]{"产品名称","级别","库号","业务模式","厂号","采购单价(/KG)",
            "箱数(小计)","合同数量(小计)","合同金额(小计:元)","发票数量(小计)","发票金额(小计:元)","成本单价(元/KG)","库存金额(元)",
            "当前库存重量","当前库存箱数"};
    //size
    public static final String[] HEAD_SALE_ARRAY = new String[]{"提货时间","销售经理","销售合同编号","客户名称","实售单价(元/KG)",
            "实售重量(kg)","实售箱数","实售金额(元)","出库单时间","定金时间","定金","客户来款时间","客户来款金额(元)","货款差额",
            "是否已结清","备注"};

    public static final String[] HEAD_CONTRACT_QUERY_ARRAY = new String[]{"外合同编号","内合同编号","外商","合同日期",
            "合同总重量","合同总金额","发票总重量","发票总金额","总箱数","原产地","币种","ETD","ETA","预计船期","目的港","状态"};
    public static final String[] HEAD_CARGO_QUERY_ARRAY = new String[]{"外合同编号","内合同编号","外商","原产地","合同日期",
            "厂号","柜号","币种","商品","级别","库存箱数","单价","合同重量","合同金额","发票重量","发票金额","ETD","ETA","预计船期",
            "目的港","状态"};
    public static final String[] HEAD_DUTY_ARRAY = new String[]{"外合同编号","内合同编号","外商","报关单号","付税日期","关税",
            "增值税","货代","放行日期","仓库","入库时间"};
